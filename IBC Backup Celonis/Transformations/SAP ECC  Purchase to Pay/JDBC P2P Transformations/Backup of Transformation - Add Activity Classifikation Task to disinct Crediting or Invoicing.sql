...
SELECT DISTINCT
	...
	,E.EBELN AS "EBELN"
	,E.EBELP AS "EBELP"
	,Case when BKPF_Z.BLART = 'KG' then 'Typ: Gutschrift' else 'Typ: Rechnung' end AS "ACTIVITY_DE"
	,case when BKPF_Z.BLART = 'KG'then 'Type: Crediting' else 'Type: Invoice' end AS "ACTIVITY_EN"
	,CASE 
